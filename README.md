...
- From Chapter 7 onwards, we will start working on more real applications. In Chapter 7 we will work on systems for archiving and searching through collections of text. We introduce you to the field of Information Retrieval and build a simple information retrieval system. This chapter furthers your knowledge about Object Oriented Programming.
- In Chapter 8 we create a complete web applicatioon to search through your own library of PDF files. This will be our first real application ready for use by end-users. The Chapter introduces you to many modules available in the standard library as well as third-party modules.
